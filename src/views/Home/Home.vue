  ...
  <div class="home_container">
    ...
    <div class="list-container">
      <div class="sortList clearfix">
        <div class="center">
          <!--banner轮播-->
          <el-carousel height="455px" trigger="click">
        ...
        <div class="tab-content">
          <div class="tab-pane">
            <div class="floor-1">
              ...
              <el-carousel height="360px" trigger="click" class="floorBanner">
...
export default {
  ...
  data () {
    return {
      list: [require('@/views/Home/images/floor-1-b01.png'), require('@/views/Home/images/floor-1-b01.png'), require('@/views/Home/images/floor-1-b01.png')]
    }
  },
  computed: {
    // 拿取banner数据
